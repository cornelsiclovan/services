 ...
 */
final class Version20190726072408 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD preview TEXT NOT NULL, CHANGE url url VARCHAR(255) DEFAULT NULL');
    }
