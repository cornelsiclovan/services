 ...
 */
final class Version20190716083200 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE service_offer ADD rating DOUBLE PRECISION NOT NULL, ADD rating_comment TEXT NOT NULL');
    }
